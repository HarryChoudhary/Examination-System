  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/CAM00121.jpg.jpg" width=100 height=100 alt="Harish Choudhary" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="https://www.facebook.com/choudharyharish68" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Harish Choudhary</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+917785068889</h4>
		<h4 style="font-family:'typo' ">choudharyharish68@gmail.com</h4>
		<h4 style="font-family:'typo' ">Pccoe,Pune</h4></div></div>
		</p>
      </div>
